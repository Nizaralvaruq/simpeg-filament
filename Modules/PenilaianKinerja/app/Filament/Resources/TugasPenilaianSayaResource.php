...
use Modules\PenilaianKinerja\Filament\Resources\TugasPenilaianSayaResource\Pages;
use Filament\Forms\Components\Repeater; // Added for the new form method

class TugasPenilaianSayaResource extends Resource
{
                    ...
                    ->schema(function (AppraisalAssignment $record) {
                        ...
                        foreach ($categories as $category) {
                            ...
                            if (!empty($indicatorFields)) {
                                $steps[] = \Filament\Schemas\Components\Wizard\Step::make($category->name)
    ...
    {
        return [
            'index' => Pages\ListTugasPenilaianSaya::route('/'),
        ];
    }
}
