...
use Modules\PenilaianKinerja\Filament\Resources\AppraisalSessionResource\Pages;
...
class AppraisalSessionResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListAppraisalSessions::route('/'),
            'create' => Pages\CreateAppraisalSession::route('/create'),
            'edit' => Pages\EditAppraisalSession::route('/{record}/edit'),
        ];
    }
}
