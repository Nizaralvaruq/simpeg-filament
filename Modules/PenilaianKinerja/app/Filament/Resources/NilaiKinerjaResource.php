...
use Modules\PenilaianKinerja\Filament\Resources\NilaiKinerjaResource\Pages;
...
class NilaiKinerjaResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListNilaiKinerja::route('/'),
            'create' => Pages\CreateNilaiKinerja::route('/create'),
            'view' => Pages\ViewNilaiKinerja::route('/{record}'),
            'edit' => Pages\EditNilaiKinerja::route('/{record}/edit'),
        ];
    }
