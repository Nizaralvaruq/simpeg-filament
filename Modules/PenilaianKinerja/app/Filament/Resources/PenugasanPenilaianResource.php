...
use Modules\PenilaianKinerja\Filament\Resources\PenugasanPenilaianResource\Pages;
...
class PenugasanPenilaianResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListPenugasanPenilaian::route('/'),
            'create' => Pages\CreatePenugasanPenilaian::route('/create'),
            'edit' => Pages\EditPenugasanPenilaian::route('/{record}/edit'),
        ];
    }
}
