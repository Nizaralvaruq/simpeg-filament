<div>
    <div class="grid grid-cols-1 gap-4 mb-6">
        ...
        <div class="rounded-xl bg-white dark:bg-gray-900 p-4 sm:p-6 shadow-sm ring-1 ring-gray-950/5 dark:ring-white/10 transition-all hover:ring-gray-950/10 dark:hover:ring-white/20">
            <div class="flex items-center gap-x-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-2xl font-bold tabular-nums text-warning-600 dark:text-warning-400">{{ $tugasPending }}</p>
        ...
        <div class="rounded-xl bg-white dark:bg-gray-900 p-4 sm:p-6 shadow-sm ring-1 ring-gray-950/5 dark:ring-white/10 transition-all hover:ring-gray-950/10 dark:hover:ring-white/20">
            <div class="flex items-center gap-x-4">
                <div class="shrink-0 p-2">
                    <svg class="h-8 w-8 text-danger-600 dark:text-danger-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <div>
                    ...
                    <p class="mt-1 text-2xl font-bold tabular-nums text-danger-600 dark:text-danger-400">{{ $tugasExpired }}</p>
