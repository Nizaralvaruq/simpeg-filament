        ...
        <div class="flex items-center gap-4 py-3">
            ...
            <div class="flex-1">
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Anda memiliki <span class="font-extrabold text-warning-600 dark:text-warning-400">{{ $count }} rekan</span> yang belum dinilai untuk periode <strong>{{ now()->translatedFormat('F Y') }}</strong>.
                </p>
